...
function dotCategoria(categoria) {
  ...
  if (categoria === 'CERTIFICADO') return 'bg-violet-500'
  if (categoria === 'CONCURSO DE MÉRITO') return 'bg-fuchsia-500'
  if (categoria === 'PLANILLA DE CALIFICACIÓN') return 'bg-cyan-500'  
